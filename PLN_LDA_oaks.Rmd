...
Find the linear combinations $\mathbf{Z}\mathbf{u}, \mathbf{u}\in\mathbb{R}^p$ maximizing separation between groups
...
---
# Poisson discimminant analysis: solution
...
## Features
  ...
  - **Graphical representation**:  $\mathbb{E}_q [\mathbf{Z}] \mathbf{P} \Lambda^{1/2}$, the coordinates along the discriminant axes

...
axes[0].grid(True)
axes[1].grid(True)
axes[0].set_title("Histogram of log of non zero counts", fontsize = 25)
axes[1].set_title("Histogram of log sum of counts", fontsize = 25)
plt.show()
...
axes[0].set_xlabel("Counts", fontsize = 25)
axes[1].set_xlabel("Counts", fontsize = 25)
axes[0].set_ylabel("Predicted counts", fontsize = 25)

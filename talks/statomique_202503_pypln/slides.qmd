...
- All the chromosomes placed end to end $\implies$ **500 loci**, for $\textbf{4 different species of sheep}$.
...
```{python}
ar.viz_dims(indices_of_variables = [0,1,2,3], variable_names = ["Sheep1", "Sheep2", "Sheep3", "Sheep4"])
```
...
ax.set_xticklabels(["Sheep1", "Sheep2", "Sheep3", "Sheep4"], fontsize = 12)
plt.show()
```
:::
